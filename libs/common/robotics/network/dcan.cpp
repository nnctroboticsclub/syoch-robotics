...
void DistributedCAN::OnKeepAliveLost(can_module::KeepAlive::KeepAliveLostCallback cb) {
  keep_alive_mod.OnKeepAliveLost(cb);
}
void DistributedCAN::OnKeepAliveRecovered(can_module::KeepAlive::KeepAliveRecoverdCallback cb) {
